...
function pk_stt2_db_save_searchterms( $meta_value) {	
	if ( strlen($meta_value) > 3 ){		
		...
		global $wpdb; 
		$success = $wpdb->query( "INSERT INTO ".$wpdb->prefix."stt2_meta ( `post_id`,`meta_value`,`meta_count` ) VALUES ( %s, %s, 1 )
...
function pk_stt2_is_contain_bad_words( $term ){
 ...
 if( false === strpos( $term, '***' ) ) return false; else return true; 
}
/**
